                                ...
                                <div class="grid grid-cols-6 gap-6">
                                    <div class="col-span-6 sm:col-span-6">
                                        <label for="name" 
                                            ...
                                            :class="{'text-red-700': form.errors.name, 'text-gray-900': !form.errors.name}"
                                        >
                                            Product name
                                        </label>
                                    ...
                                    <div class="col-span-6 sm:col-span-6 space-x-2">
                                        ...
                                        <Link :href="route('product.show', product.id)" class="text-gray-900 bg-white border border-gray-300 focus:outline-none hover:bg-gray-100 focus:ring-4 focus:ring-gray-200 font-medium rounded-lg text-sm px-5 py-2.5">Cancel</Link>
                                    </div>
                                </div>
                            </div>
                        </form>
